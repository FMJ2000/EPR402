...
void OLED_Init( void )
{
    I2C_Write(SSD1306_ADDR, 0x00, SSD1306_DISPLAY_OFF);
    I2C_Write(SSD1306_ADDR, 0x00, SSD1306_SET_DISPLAY_CLOCK_DIV_RATIO);
    I2C_Write(SSD1306_ADDR, 0x00, 0x80);
    I2C_Write(SSD1306_ADDR, 0x00, SSD1306_SET_MULTIPLEX_RATIO);
    I2C_Write(SSD1306_ADDR, 0x00, SSD1306_LCDHEIGHT - 1);
    I2C_Write(SSD1306_ADDR, 0x00, SSD1306_SET_DISPLAY_OFFSET);
    I2C_Write(SSD1306_ADDR, 0x00, 0x00);
    I2C_Write(SSD1306_ADDR, 0x00, SSD1306_SET_START_LINE|0x0);
    I2C_Write(SSD1306_ADDR, 0x00, SSD1306_CHARGE_PUMP);
    I2C_Write(SSD1306_ADDR, 0x00, 0x14);
    I2C_Write(SSD1306_ADDR, 0x00, SSD1306_MEMORY_ADDR_MODE);
    I2C_Write(SSD1306_ADDR, 0x00, 0x00);
    I2C_Write(SSD1306_ADDR, 0x00, SSD1306_SET_SEGMENT_REMAP|0x01);
    I2C_Write(SSD1306_ADDR, 0x00, SSD1306_COM_SCAN_DIR_DEC);
#ifdef SSD1306_128_32
    I2C_Write(SSD1306_ADDR, 0x00, SSD1306_SET_COM_PINS);
    I2C_Write(SSD1306_ADDR, 0x00, 0x02);
    I2C_Write(SSD1306_ADDR, 0x00, SSD1306_SET_CONTRAST_CONTROL);
    I2C_Write(SSD1306_ADDR, 0x00, 0x8F);
#elif defined SSD1306_128_64 
    I2C_Write(SSD1306_ADDR, 0x00, SSD1306_SET_COM_PINS);
    I2C_Write(SSD1306_ADDR, 0x00, 0x12);
    I2C_Write(SSD1306_ADDR, 0x00, SSD1306_SET_CONTRAST_CONTROL);
    I2C_Write(SSD1306_ADDR, 0x00, 0xCF);
#endif
    I2C_Write(SSD1306_ADDR, 0x00, SSD1306_SET_PRECHARGE_PERIOD);
    I2C_Write(SSD1306_ADDR, 0x00, 0xF1);
    I2C_Write(SSD1306_ADDR, 0x00, SSD1306_SET_VCOM_DESELECT);
    I2C_Write(SSD1306_ADDR, 0x00, 0x40);
    I2C_Write(SSD1306_ADDR, 0x00, SSD1306_DISPLAY_ALL_ON_RESUME);
    I2C_Write(SSD1306_ADDR, 0x00, SSD1306_NORMAL_DISPLAY);
    I2C_Write(SSD1306_ADDR, 0x00, SSD1306_DEACTIVATE_SCROLL);
    I2C_Write(SSD1306_ADDR, 0x00, SSD1306_DISPLAY_ON);
...
{
    I2C_Write(SSD1306_ADDR, 0x00, SSD1306_SET_COLUMN_ADDR);
    I2C_Write(SSD1306_ADDR, 0x00, 0x0);
    I2C_Write(SSD1306_ADDR, 0x00, SSD1306_LCDWIDTH-1);
    I2C_Write(SSD1306_ADDR, 0x00, SSD1306_SET_PAGE_ADDR);
    I2C_Write(SSD1306_ADDR, 0x00, 0x0);
 #if SSD1306_LCDHEIGHT == 64
    I2C_Write(SSD1306_ADDR, 0x00, 0x7);// Page end address
  #endif
  #if SSD1306_LCDHEIGHT == 32
    I2C_Write(SSD1306_ADDR, 0x00, 0x3); // Page end address
  #endif
  #if SSD1306_LCDHEIGHT == 16
    I2C_Write(SSD1306_ADDR, 0x00, 0x1); // Page end address
  #endif

    
    I2C_Master_Start();
    I2C_Master_Write(SSD1306_ADDR << 1);
    I2C_Master_Write(0x40);
    for (uint16_t i = 0; i < (SSD1306_LCDWIDTH*SSD1306_LCDHEIGHT/8); i++) I2C_Master_Write(buffer[i]);
    I2C_Master_Stop();
}
...
{
    I2C_Write(SSD1306_ADDR, 0x00, SSD1306_SET_CONTRAST_CONTROL);
    I2C_Write(SSD1306_ADDR, 0x00, contrast);
}
...
{
  if( value ) I2C_Write(SSD1306_ADDR, 0x00, SSD1306_INVERT_DISPLAY);
  else I2C_Write(SSD1306_ADDR, 0x00, SSD1306_NORMAL_DISPLAY);
}
